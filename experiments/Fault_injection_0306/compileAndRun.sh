...
while read -r line; do
    ...
    echo -e "$line\n"
    # Config input.yaml
    python3 ../../src/scripts/genInputYaml_trace.py ${fi_index}
    # Instrument it
    $LLFI_BUILD_ROOT/bin/instrument -lstdc++ --readable "$fname.ll"
    ...
    # Backup data
    rm -rf ../../data/LULESH_FITrace_0103/lulesh-${line}
    mkdir ../../data/LULESH_FITrace_0103/lulesh-${line}
    cp -r ./llfi/ ../../data/LULESH_FITrace_0103/lulesh-${line}/
